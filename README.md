# cb-oralhistory (annotated media version)


**cb-oralhistory** is a mix of [CollectionBuilder-CSV](https://github.com/CollectionBuilder/collectionbuilder-csv) and [Oral History as Data (OHD)](https://github.com/oralhistoryasdata/oralhistoryasdata.github.io). This version has been extended to allow for the inclusion of time-coded descriptive metadata in addition to (or instead of) a full transcript. In this regard, it is similar in spirit to the [OHMS Viewer](https://github.com/uklibraries/ohms-viewer). This repository is meant to serve as a starter for those wanting to build oral history or other annotated media collections with CollectionBuilder. 

The current demo site features a small mix of transcripts and other annotations. Item pages are generated by a CSV metadata file that includes the display_template "annotated-media" as a field. Transcriptions and/or time-coded descriptions are generated from CSV files located in `_data/transcripts` or `_data/timepoints`, respectively.
